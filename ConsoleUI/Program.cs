...
namespace ConsoleUI
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("{0} {1} {2} {3} {4}", item.RentalId, item.CarName, item.CompanyName, item.RentDate, item.ReturnDate);
            }
            ...
            //                                    Console.Write("Aracın Teslim Edilecek Kira Id Numarasını Giriniz:  ");
            //                                    updateRental.RentalId = int.Parse(Console.ReadLine());
            //                                    Console.Clear();
            //                                    Console.Write("Müşteri Numarasını Giriniz:  ");
            //                                    updateRental.CustomerId = int.Parse(Console.ReadLine());
            //                                    Console.Clear();
            //                                    Console.Write("Aracın Id Numarasını Giriniz:  ");
            //                                    updateRental.CarId = int.Parse(Console.ReadLine());
            //                                    Console.Clear();
            //                                    Console.Write("Aracın Teslim Edildiğini Onaylayın");
            //                                    Console.ReadLine();
            ...
            //{
            //    string[] menus = new string[] { "Marka Ekleme", "Renk Ekleme", "Araç Ekleme","Araç Bul","Araç Kirala","Kiralık Araç Güncelleme" };
            //    for (int i = 0; i < menus.Length; i++)
            //    {
            //        Console.WriteLine($"{i + 1} {menus[i]}");
            //    }
